...
namespace FroggerStarter.Controller
{
    ...
    public class SoundManager
    {
        ...
        public async void PlayVehicleCollisionSound()
        {
            ...
            var folder = await Windows.ApplicationModel.Package.Current.InstalledLocation.GetFolderAsync("Assets\\PlayerDying");
        ...
        {
            var element = new MediaElement();
            var folder = await Windows.ApplicationModel.Package.Current.InstalledLocation.GetFolderAsync("Assets\\Game Sounds");
